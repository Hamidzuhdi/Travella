...
def get_recommendations(top_place_id=None, category=None, city=None, top_n=50):
    if top_place_id:
...
recomendation = recommend_place(user_id = 3)
#recomendation = recomendation_by_category(user_id=1, category='Taman Hiburan')
print(recomendation)
